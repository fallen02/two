...
export function Marketing() {
  return (
    <Container className="relative flex flex-col py-24 justify-center items-center gap-5">
      ...
      <div className="flex flex-col gap-3 items-center justify-center">
        ...
        <h1 className="text-5xl  font-semibold">Digital Marketing Solution</h1>
      </div>
      <p className="max-w-xl text-center">
        Enhance your marketing strategy with automation, real-time insights and
        advanced targating - all in one seamless platform.
      </p>

      <div className="flex gap-4 mt-10">
        {cardDatas.map((card, idx) => (
          <div key={idx} className="flex flex-col gap-5 justify-center items-center text-center bg-accent/50 p-10 rounded-lg shadow-xl hover:shadow-none border-2">
